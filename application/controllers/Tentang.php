    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (!$this->upload->do_upload('foto_tentang')) {
                ...
                $this->m_tentang->perbaharui($data);
                $this->session->set_flashdata('pesan', 'Tentang Aguaria Berhasil Perbaharui');
                redirect('tentang');
            }
            ...
            $this->m_tentang->perbaharui($data);
            $this->session->set_flashdata('pesan', 'Tentang Aguaria berhasil di Perbaharui');
            redirect('tentang');
        }
