    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add Proses Produksi Smallpack</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                        echo form_open_multipart('proses/add');
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="nama_proses" placeholder="Nama Proses" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" type="text" name="foto_proses" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group text-center">
                            ...
                            <a href="<?= site_url('proses') ?>"><button type="button" class="btn btn-dark rounded-pill">Kembali</button>
                        </div>
