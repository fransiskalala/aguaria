                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" type="text" name="foto_produk" required>
                            </div>
                        </div>
                            ...
                            <div class="form-group text-center">
                                ...
                                <a href="<?= site_url('produk') ?>"><button type="button" class="btn btn-dark rounded-pill">Kembali</button>
                            </div>
