            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                        echo form_open_multipart('tentang/add');
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="nama_tentang" placeholder="Nama tentang" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" type="text" name="foto_tentang" required>
                            </div>
                        </div>

                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-success rounded-pill">Simpan</button>
                                <a href="<?= site_url('tentang') ?>"><button type="button" class="btn btn-dark rounded-pill">Kembali</button>
                            </div>
