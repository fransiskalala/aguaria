              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Silahkan Buat Akun</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate method="POST" action="<?= base_url('auth/registrasi'); ?>">
                    <div class="col-12">
                      <label for="NamaAnda" class="form-label">Nama</label>
                      <input type="text" name="nama" class="form-control" id="nama" required>
                      <?= form_error('nama', '<span class="text-danger ml-4">', '</span>'); ?>
                    </div>

                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Email</label>
                      <input type="email" name="email" class="form-control" id="email" required>
                      <?= form_error('email', '<span class="text-danger ml-4">', '</span>'); ?>
                    </div>

                    <div class="col-12">
                      <label for="UsernameAnda" class="form-label">Username</label>
                      <div class="input-group has-validation">
                        <input type="text" name="username" class="form-control" id="username" required>
                        <?= form_error('username', '<span class="text-danger ml-4">', '</span>'); ?>
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="PasswordAnda" class="form-label">Password</label>
                      <input type="password" name="password1" class="form-control" id="password1" required>
                      <?= form_error('password1', '<span class="text-danger ml-4">', '</span>'); ?>
                    </div>

                    <div class="col-12">
                      <label for="PasswordAndaRepeat" class="form-label">Ulang Password</label>
                      <input type="password" name="password2" class="form-control" id="password2" required>
                      <?= form_error('password2', '<span class="text-danger ml-4">', '</span>'); ?>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Sudah Memiliki Akun?<a href="<?= base_url('auth')?>">Log in</a></p>
                    </div>
                  </form>
